...
Ext.define('Wuis.util.Logger', {trackExtLogs:!0, trackExtErrors:!0, trackJsErrors:!0, sizeLimit:100, timeLimit:30000, timeoutOnError:1000, serviceUrl:'/rest/Log/log', logs:null, constructor:function() {
  var a = this;
  a.logs = [];
  a.callParent(arguments);
  a.restartTimeout();
}, trackLog:function() {
  var a = this, b = a.normalizeArgs.apply(a, arguments);
  ...
  var b = this;
  b.logs.push({level:a, message:d, timestamp:c || Date.now()});
  b.checkLogSize(a);
  ...
  Ext.Ajax.request({url:this.serviceUrl, method:'POST', jsonData:a});
  ...
  return {level:b, message:a};
}, init:function() {
  var a = this, b = Ext.log;
  function trackedLog() {
    a.trackLog.apply(a, arguments);
    b.apply(this, arguments);
  }
  function logx(e, a) {
    var b = arguments && arguments.callee && arguments.callee.caller, c, d;
    for (d = 0; b && d < 5; d += 1) {
...
Ext.define('Wuis.controller.EventLogger', {extend:'Ext.app.Controller', init:function() {
  var ctrl = this;
  ctrl.control({'panel':{render:'onPanelRender', close:'onPanelClose', collapse:'onPanelCollapse', expand:'onPanelExpand'}, 'button':{click:'onButtonClick'}});
  Ext.app.Controller.prototype.init.call(this);
}, log:function(actual) {
  Ext.log.info(actual);
}, buttonProperties:['$className', 'text', 'tooltip', 'iconCls', 'itemId', 'functionId'], panelProperties:['$className', 'title'], formatText:function(text, obj, start) {
  ...
  var b = data.title || '';
  if ((!b || b === '\x26#160;') && className.match(/^Ext/)) {
    return;
  }
