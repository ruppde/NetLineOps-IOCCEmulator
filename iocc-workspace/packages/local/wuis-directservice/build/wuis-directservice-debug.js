...
Ext.define('Wuis.ajax.DirectService', {singleton:true, useMsgBoxDialog:true, isWorking:false, provide:function(services, namespace) {
  var service, k, v;
  if (!namespace) {
    namespace = '';
  }
  ...
  var serviceCallScope = this, url = service.url, method = service.method || 'GET', paramsKind = service.paramsKind || {}, GETMethod = service.method === 'GET' ? 'QUERY' : 'BODY', queryParams = {}, bodyParams = {}, startTime = +new Date, serviceCallId = Ext.id(), b, g;
  ...
  Ext.Ajax.request({service:service, serviceCallParams:serviceCallParams, serviceCallId:serviceCallId, url:url, method:method, serviceCallback:serviceCallback, serviceScope:m, startTime:startTime, params:queryParams, jsonData:method === 'GET' ? undefined : bodyParams, callback:serviceCallScope.callServiceCallback, scope:serviceCallScope});
}, callServiceCallback:function(objService, i, b) {
  var serviceCallScope = this, g = +new Date, c = i ? Ext.decode(b.responseText, true) : undefined, h = +new Date, f, e;
  ...
  if (this.useMsgBoxDialog) {
    b = Ext.create('Ext.window.MessageBox', {id:'loadmask-' + c});
    b.wait(a.loadingText || 'Loading', null, {interval:40, increment:Math.round((a.loadingTime || 2000) / 40)});
  } else {
    b = Ext.widget('box', {floating:true, id:'loadmask-' + c, html:'\x3cdiv id\x3d"' + id + '-msgWrapEl" data-ref\x3d"msgWrapEl" class\x3d"x-mask-msg" role\x3d"presentation" style\x3d""\x3e\x3cdiv id\x3d"' + id + '-msgEl" data-ref\x3d"msgEl" class\x3d"x-mask-loading x-mask-msg-inner " role\x3d"presentation"\x3e' + '\x3cdiv id\x3d"' + id + '-msgTextEl" data-ref\x3d"msgTextEl" class\x3d"x-mask-msg-text" role\x3d"presentation"\x3e' + (a.loadingText || 'Loading...') + '\x3c/div\x3e\x3c/div\x3e\x3c/div\x3e', 
    shadow:false, cls:'x-mask'});
    b.show();
  }
