...
folder are mapped to the application's root namespace, 'TimesSquare'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "TimesSquare"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'TimesSquare' in the same way
as `"TimesSquare/sass/src"`.
